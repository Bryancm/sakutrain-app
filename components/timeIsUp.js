...
export const TimeIsUp = ({timeIsUp, setTimeIsUp, limit, correct, wrong, posts, time, timeLimit, restartGame}) => {
        ...
        <MotiView
          ...
          <Layout
            ...
            <LottieView
              ...
              source={require('../assets/lf30_editor_6lx7s8p6.json')}
              autoPlay
              loop={true}
            />
          </Layout>
